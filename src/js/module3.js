document.addEventListener("DOMContentLoaded", () => {
  ...
  const correctOrder = [
    "Recevoir la requête HTTP (GET /articles)",
    "Demander la liste des articles au Modèle",
    "Récupérer la liste des articles du Modèle",
    "Choisir la Vue 'liste_articles'",
    "Envoyer les données (la liste) à la Vue",
    "Renvoyer la réponse HTML au navigateur",
  ];
  ...
  actionContainer.addEventListener("click", (e) => {
    if (e.target.tagName === "BUTTON") {
      ...
      if (clickedAction === nextCorrectAction) {
        ...
        feedbackMessage.textContent =
          "Erreur ! L'ordre est incorrect. On recommence.";
